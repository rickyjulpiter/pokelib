...
export default class MyPokeLibCard extends Component {
    ...
    releaseButtonHandler = (pokemonIndex, name, url) => {
        var apiEndpoint = `https://pokelibapi.sistempintar.com/?id=${pokemonIndex}`
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-footer text-muted">
                            <button 
                                ...
                                onClick={() => this.releaseButtonHandler(this.state.pokemonIndex, this.state.name, this.state.linkAPI)}
                            >
                                    Release
                            </button>
                        </div>
